...
- Platforms and frameworks used: <img title="Unity" alt="Alt text" style="width:25px;height:25px;" src="https://simpleicons.org/icons/unity.svg"> <img title="Unity" alt="Alt text" style="width:25px;height:25px;" src="[https://simpleicons.org/icons/unity.svg](https://simpleicons.org/icons/django.svg)"> 
